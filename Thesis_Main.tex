...
\afterpreface                      
  ...
  \include{chapters_after_preface/2.Background}
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}
       
  \include{chapters_after_preface/3.SystemOverview}
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}

  \include{chapters_after_preface/4.HandwritingRec}
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}

         \include{chapters_after_preface/5.AbstractGen}
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}
       
  \include{chapters_after_preface/6.TextGenImage}
        \setcounter{figure}{0}
        \setcounter{equation}{0}
        \setcounter{table}{0}

          \include{chapters_after_preface/7.Results}
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}

         \include{chapters_after_preface/8.Conclusion}
       \setcounter{figure}{0}
       \setcounter{equation}{0}
       \setcounter{table}{0}
