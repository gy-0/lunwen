...
The system architecture employs a layered modular design that integrates multiple AI technologies while maintaining clear separation of responsibilities and efficient data flow. Figure \ref{fig:system_architecture} illustrates the overall system structure and component relationships.
...
\begin{figure}[H]
    ...
    \node[component, below left=of controller] (ocr) {OCR \& Image\\Processing};
    ...
    % Data Storage
    \node[component, below=of ocr] (storage) {Configuration \&\\Data Management};
